...
exports.default = ({ USER_NAME, USER_EMAIL, MESSAGE, GITHUB_TOKEN, tagName, tagMsg, branch, trailer, }) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        try {
            if (trailer != '') {
                yield (0, exec_1.exec)('git', ['commit', '-v', '--trailer', `${trailer}`, '-m', `${MESSAGE}`], options);
            }
            else {
